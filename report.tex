...
Theory expects nearly unchanged centerline speed if cross‐section remains constant; curvature may induce secondary Dean vortices. For the sharp bend channel, velocity before the bend was measured at 714.988 micrometers/second with valocity after the bend of 528.127 micrometers/second. For the curved bend channel, centerline velocities were measured at 560.019 micrometers/second and 694.1 micrometers/second before and after the bend, respectively. The discrepancy in flow velocities comes from the generated Dean vortices, where lower velocity from the outer walls shifts toward the centerline and higher velocity flow shifts outwards, creating a more uniform flow velocity profile, and potentially resulting in the difference in measured velocity results.
...
% ---------------------------------------------------------
\section{Conclusion}
Microfluidic flows are dominated by viscosity. Straight channels exhibit Poiseuille profiles with maximum velocity at the centerline. Channel shape strongly influences pressure loss and bead trajectory. When data are included, measured results should validate theory in the laminar regime.
