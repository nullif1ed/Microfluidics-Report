...
alpha = (known physical length) / (measured pixel length)

All measured lengths are then multiplied by alpha to convert to physical units.
...
Q proportional to (Δp) / (μL), and Q = S * U

Since Δp = ρ * g * z1,  
we have U3 proportional to z1.
...
Torricelli’s law gives U approximately equal to sqrt(2 * g * Δz).  
Thus, U3 proportional to sqrt(z1).

Comparing:
\begin{itemize}
  \item Hagen–Poiseuille: U3 proportional to z1
  \item Bernoulli: U3 proportional to sqrt(z1)
\end{itemize}
